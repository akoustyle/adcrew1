...
campaign_one = Campaign.create(name: "Laino Cosmetics", objectif: "Check everything is working properly", activation: "Web only", reach: "2M", tag: true)
puts "saving Laino Cosmetics..."
campaign_one.save!

campaign_two = Campaign.create(name: "Lounge wear", objectif: "Check everything is working properly", activation: "Print & Digital", reach: "40K", tag: false)
puts "saving Lounge wear..."
campaign_two.save!

campaign_three = Campaign.create(name: "Jean-Paul Gaultier", objectif: "Check everything is working properly", activation: "Print & Digital", reach: "5M", tag: true)
puts "saving Jean-Paul Gaultier..."
campaign_three.save!

campaign_four = Campaign.create(name: "Pretty Little Thing", objectif: "Check everything is working properly", activation: "Print & Digital", reach: "600K", tag: true)
puts "saving Pretty Little Thing..."
campaign_four.save!

campaign_five = Campaign.create(name: "Cacharel", objectif: "Check everything is working properly", activation: "Print & Digital", reach: "7K", tag: false)
